...
Produces files like:
    ...
    docs/media/videos/omnilink/omniquad.mp4
    ...
...
DEMOS: List[Dict[str, Any]] = [
    {"world": "omnilink_tb3_burger.omniworld",   "out": "tb3_burger.mp4",   "port": 8765, "prompt": "forward 1 meter, then turn left 90 degrees"},
    {"world": "omnilink_tb3_waffle.omniworld",   "out": "tb3_waffle.mp4",   "port": 8765, "prompt": "forward 1 meter"},
    {"world": "omnilink_tb3_waffle_pi.omniworld","out": "tb3_waffle_pi.mp4","port": 8765, "prompt": "spin"},
    {"world": "omnilink_husky.omniworld",        "out": "husky.mp4",        "port": 8765, "prompt": "circle"},
    {"world": "omnilink_jackal.omniworld",       "out": "jackal.mp4",       "port": 8765, "prompt": "turn around"},
    {"world": "omnilink_rosbot.omniworld",       "out": "rosbot.mp4",       "port": 8765, "prompt": "forward 1 meter"},
    {"world": "omnilink_rosbot_xl.omniworld",    "out": "rosbot_xl.mp4",    "port": 8765, "prompt": "forward 1 meter"},
    {"world": "omnilink_omniquad.omniworld",         "out": "omniquad.mp4",         "port": 8765, "prompt": "wave hello"},
]
