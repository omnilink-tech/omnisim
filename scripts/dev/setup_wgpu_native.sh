...
#     projects/samples/demos/worlds/rendering/camera_wgpu_scene_smoke.omniworld \
#     --duration 6
#
# Expected log line in omnisim_log.txt:
#   INFO: [OmCamera scene] first draw: idx=36 baseColor=(0.00,1.00,1.00) ...
#   INFO: [OmCamera] 'cam_wgpu' rendered through wgpu (64x48, 1 draw)
...
# Pinned to v29.0.0.0: OmVulkanBackend.cpp is "API tracked against wgpu-native
...
echo "      projects/samples/demos/worlds/rendering/camera_wgpu_scene_smoke.omniworld \\"
echo "      --duration 6"
echo
