...
$world = if ($Free) { "$root\projects\policies\research\worlds\${Robot}_parity_probe_free.omniworld" }
         else       { "$root\projects\policies\research\worlds\${Robot}_parity_probe.omniworld" }
