...
"long-running G1 deploy gap" (WbNewtonBackend.cpp). The robust fix is self-describing worlds: pin
...
ROBOT_TOKENS = ("g1", "atlas", "h1", "valkyrie",
                "spot", "go2", "b2", "anymal")
...
def main():
    ...
    if args.paths:
        ...
        files = sorted(glob.glob(os.path.join(REPO, "projects", "rl", "worlds", "*.wbt")))
