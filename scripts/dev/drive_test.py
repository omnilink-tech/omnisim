...
Runs projects/robot_combat/worlds/tests/drive_test.wbt headless (the drive_demo controllers each
...
Usage: python scripts/dev/drive_test.py [newton|ode] [sim_ms]
...
WORLD = REPO / "projects" / "robot_combat" / "worlds" / "tests" / "drive_test.wbt"
OMEGA = 12.0
