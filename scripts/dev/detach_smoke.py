...
Usage:
    python scripts/dev/detach_smoke.py [world] [parts] [sim_ms]
      world  default projects/robot_combat/battlebots/worlds/battlebox_duel.omniworld
...
def main():
    ...
    # RETIRED KNOBS, SCRUBBED ON PURPOSE: both name a backend that no longer
    # exists (src/ode deleted, commit bdc02139). Honouring a stale export from the
    # operator's shell would give a physics-FREE run, not a legacy-physics one.
