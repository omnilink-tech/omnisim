...
# physics-free humanoid (H1) self-walking across the floor playing
...
#     -Robot  h1
#             ("valkyrie" removed 2026-08-24 -- the robot package went in
#              be41986f8 and took ${Robot}_shadow_demo.omniworld with it)
...
$world = "$root\projects\policies\research\worlds\${Robot}_shadow_demo.omniworld"
