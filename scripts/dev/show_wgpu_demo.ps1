...
#   powershell -File scripts\dev\show_wgpu_demo.ps1 projects\samples\demos\worlds\showcase\warehouse_husky.omniworld
#
param([string]$World = "projects\samples\demos\worlds\showcase\warehouse_husky.omniworld")
