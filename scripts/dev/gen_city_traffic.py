...
"""Generate the living-city world showcase/city_traffic.omniworld for an NxN street grid,
...
WORLD = os.path.join(REPO, "projects/samples/demos/worlds/showcase/city_traffic.omniworld")
