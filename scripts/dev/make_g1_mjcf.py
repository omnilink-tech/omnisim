...
the deploy (OmNewtonBackend) builds the articulation body-by-body from the
OmniSim node tree and hands THAT to SolverMuJoCo. In both cases SolverMuJoCo is
