...
Subcommands:
  ...
  inspect  <world.wbt>                 Load world, list robots/poses, exit
...
def main(argv: list[str] | None = None) -> int:
    ...
    pn.add_argument("--subject", default="spot")
    pn.add_argument("--world", default="projects/policies/worlds/spot_rl_deploy.wbt")
