...
Schema (all fields shown; many are optional with sensible defaults):
    ...
    {
      "title": "Spot RL hero",
      "slug": "spot_hero",                    # filename stem; auto from title
      "world": "projects/policies/worlds/spot_rl_deploy.wbt",
      "subject": "spot",                       # subjects.PROFILES key/alias
...
def template(title: str = "New Cinema Piece", subject: str = "spot",
             world: str = "projects/policies/worlds/spot_rl_deploy.wbt") -> dict:
