...
them well: a characteristic dimension (so a "medium close-up" of OmniQuad
...
Use `resolve(svc_base_url, "omniquad")` to get a Subject with a live world
...
PROFILES: dict[str, SubjectProfile] = {
    "omniquad": SubjectProfile(
        name="omniquad", aliases=("omnisim_omniquad", "quadruped"),
...
def resolve(svc_base_url: str, name: str, timeout_s: float = 10.0) -> Subject:
    ...
    # inconsistent naming (e.g. "omniquad" vs "OmniQuad" vs "TurtleBot3Burger").
