...
def take_screenshot(camera, category, directory, protoDirectory, protoName, options, background, colorThreshold,
    ...
    if not options.disableIconCopy:
        ...
        iconsFolder = os.path.join(OMNISIM_HOME, protoDirectory, 'icons')
        ...
        modelFolder = os.path.join(OMNISIM_HOME, 'docs', 'guide', 'images', category, categoryFolder, protoName)
        modelPath = os.path.join(modelFolder, 'model' + namePostfix + '.png')
        if category == categoryFolder:  # appearances
            modelFolder = os.path.join(OMNISIM_HOME, 'docs', 'guide', 'images', category)
            modelPath = os.path.join(modelFolder, protoName + namePostfix + '.png')
        elif category == 'robots':
            modelFolder = os.path.join(OMNISIM_HOME, 'docs', 'guide', 'images', category, categoryFolder)
            modelPath = os.path.join(modelFolder, protoName + namePostfix + '.png')
...
def process_appearances(supervisor, parameters):
    ...
    protoPath = protoPath.replace(OMNISIM_HOME + os.sep, '')
...
if options.singleShot:
    ...
    with open('appearances.json') as json_data:
        ...
        for rootPath, dirNames, fileNames in os.walk(os.path.join(OMNISIM_HOME, 'projects', 'appearances', 'protos')):
