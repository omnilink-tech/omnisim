...
declare -a BASE_PACKAGES=(
  ...
  "tar"                               # OmniSim dependencies
  "unzip"                             # OmniSim dependencies
  ...
  "mingw-w64-x86_64-minizip"          # OmniSim (assimp)
  "mingw-w64-x86_64-zlib"             # OmniSim (assimp)
  "liblzma"                           # OmniSim
  "mingw-w64-x86_64-ffmpeg"           # OmniSim movies
