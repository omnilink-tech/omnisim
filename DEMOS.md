...
| OmniLink — OmniArm 6 + 140 mm two-finger gripper, real cloth pick (friction only) | [`omniarm6_2f140_cloth.omniworld`](projects/samples/demos/worlds/flagship/omniarm6_2f140_cloth.omniworld) | `omniarm6_2f140_cloth` |
| OmniLink — OmniArm 6 + 140 mm two-finger gripper, real pick & place (friction only) | [`omniarm6_2f140_pick_place.omniworld`](projects/samples/demos/worlds/flagship/omniarm6_2f140_pick_place.omniworld) | `omniarm6_2f140_pick_place` |
...
| Beauty Bench — Realism Study | [`beauty_bench_realism.omniworld`](projects/samples/demos/worlds/rendering/beauty_bench_realism.omniworld) | `sun_marker`; optional content variant with rounded furniture, clearer alpha-blended glazing, and a kinematic robot for rendering motion checks. [Comparison recipe](tests/rendering/BEAUTY_BENCH.md). |
