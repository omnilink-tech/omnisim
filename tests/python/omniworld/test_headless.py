...
from omniworld.validation import discover_omnisim_bin, run_headless
...
def _webots_available() -> bool:
    return discover_omnisim_bin() is not None
...
def test_validate_with_sim_reports_missing_webots(tmp_path: Path, monkeypatch):
    ...
    monkeypatch.setattr(headless_mod, "discover_omnisim_bin", lambda: None)
