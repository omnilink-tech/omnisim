...
WORLDS=(
  "tb3_burger|omnilink_tb3_burger.omniworld|drive forward one meter|drive_forward"
  "tb3_waffle|omnilink_tb3_waffle.omniworld|drive forward one meter|drive_forward"
  "tb3_waffle_pi|omnilink_tb3_waffle_pi.omniworld|drive forward one meter|drive_forward"
  "husky|omnilink_husky.omniworld|drive forward one meter|drive_forward"
  "jackal|omnilink_jackal.omniworld|drive forward one meter|drive_forward"
  "rosbot|omnilink_rosbot.omniworld|drive forward one meter|drive_forward"
  "rosbot_xl|omnilink_rosbot_xl.omniworld|drive forward one meter|drive_forward"
  "omniquad|omnilink_omniquad.omniworld|sit down|sit"
)
