...
class TestSuite (Supervisor):
    ...
    def initParserTest(self):
        ...
        self.stdoutFileManager = StdFileManager(os.path.join(self.cwdPrefix, '..', 'omnisim_stdout.txt'))
        self.stderrFileManager = StdFileManager(os.path.join(self.cwdPrefix, '..', 'omnisim_stderr.txt'))
    ...
    def run(self):
        ...
        delay = 60 if self.currentSimulationFilename.endswith('/robot_window_html.omniworld') else 30
