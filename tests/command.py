...
class Command(object):
    ...
    def runTest(self, timeout=None, silent=True, forceTermination=True, shell=False):
        ...
        self.outFileName = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'omnisim_stdout.txt')
        self.errFileName = os.path.join(os.path.dirname(os.path.abspath(__file__)), 'omnisim_stderr.txt')
        self.resetAttributes()
