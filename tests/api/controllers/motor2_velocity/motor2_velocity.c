...
int main(int argc, char **argv) {
  ...
  test_position_under_velocity_control("position sensor1", "rotational motor1", 10.0, 1);
  test_position_under_velocity_control("position sensor2", "rotational motor2", 10.0, 2);
