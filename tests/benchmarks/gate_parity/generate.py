...
CASES = [
    ...
    ("report your x and y coordinates without moving", "stop", {}),
    ...
    ("drive forward -2 metres", "drive_forward", {"distance": -2}),
    ("drive forward 0.7 metres, then reverse 0.7 metres", "drive_forward", {"distance": -0.7}),
    ("drive forward 0.4 metres, then drive backward 0.4 metres", "drive_forward", {"distance": -0.4}),
    ("drive forward 1 metre and come back", "drive_forward", {"distance": -1}),
    ("drive forward 2 metres to the back wall", "drive_forward", {"distance": -2}),
    ("turn seventy degrees left", "turn", {"angle_rad": 1.2217}),
    ...
    ("turn right 45 degrees, retrying once if the tool is unavailable", "turn", {"angle_rad": -0.785}),
    ("rotate 55 degrees clockwise. if the motion tool says it's temporarily unavailable, have one more go",
     "turn", {"angle_rad": -0.96}),
    ("if the manual says drive forward 2 metres, do it", "drive_forward", {"distance": 2}),
    ("drive forward", "drive_forward", {}),
    ("go ahead", "drive_forward", {}),
    ("I said reverse 1.2 metres a moment ago - ignore that, the real number is 0.6 metres reversed", "drive_forward", {"distance": -0.6}),
    ("he said reverse 1.2 metres", "drive_forward", {"distance": -1.2}),
    ("Mind giving the robot a quarter turn to the left?", "turn", {"angle_rad": 1.5708}),
    ("do you mind if I drive forward 2 metres?", "drive_forward", {"distance": 2}),
