...
WORLDS=(
  # robot world                            prompt
  "tb3_burger    omnilink_tb3_burger.wbt    forward 1 m"
  "tb3_waffle    omnilink_tb3_waffle.wbt    forward 1 m"
  "tb3_waffle_pi omnilink_tb3_waffle_pi.wbt forward 1 m"
  "husky         omnilink_husky.wbt         forward 1 m"
  "jackal        omnilink_jackal.wbt        forward 1 m"
  "rosbot        omnilink_rosbot.wbt        forward 1 m"
  "rosbot_xl     omnilink_rosbot_xl.wbt     forward 1 m"
  "spot          omnilink_spot.wbt          wave hello"
)
