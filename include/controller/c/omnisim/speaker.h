...
/**********************************************************************************/
/* Description:  OmniSim C programming interface for the Speaker node             */
/**********************************************************************************/
...
// "microsoft" — Windows only. Returns false on other platforms.
bool wb_speaker_set_engine(WbDeviceTag tag, const char *engine);
// e.g. "en-US", "fr-FR". Available codes depend on the host's installed Microsoft TTS voices.
