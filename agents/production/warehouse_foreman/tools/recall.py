...
"""Unified recall across warehouse_foreman's memory tiers (shim).
...
def _impl_recall(
    ...
    **_: Any,
    ...
    return _recall(
        ...
        empty_query_hint="Pass the topic you want to look up, e.g. 'husky_01 home pose' or 'cruise speed override'.",
    )
