...
Usage:
    ...
    python agents/production/husky_maze/scripts/generate_maze_world.py \
        ...
        --out projects/samples/demos/worlds/flagship/husky_maze_unknown.omniworld



The output file is byte-for-byte the same shape as

projects/samples/demos/worlds/flagship/husky_maze.omniworld — perimeter walls, internal
...
def render_world(
    ...
    """Render the .wbt text. Mirrors husky_maze.omniworld header and order so a
    ...
    lines.append("# convention as husky_maze.omniworld: 11x11 cells, 2 m each,")
    ...
    if topdown_viewport:
        ...
        # sets via OmViewpoint::topView() in src/omnisim/nodes/OmViewpoint.cpp.
