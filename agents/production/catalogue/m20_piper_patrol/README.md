...
|---|---|
| surface | `quadruped` |
| world | `projects/samples/demos/worlds/chat/omnilink_m20_piper.omniworld` |
| bridge | `8765` |
| steps | 4, each checked |

```bash
python scripts/dev/run_agent_catalogue.py --only m20_piper_patrol
```
