# tb3_waffle_pi — delivery

Run to a coordinate and come home.
...
|---|---|
| surface | `mobile` |
| world | `projects/samples/demos/worlds/chat/omnilink_tb3_waffle_pi.omniworld` |
| bridge | `8765` |
| steps | 4, each checked |

```bash
python scripts/dev/run_agent_catalogue.py --only tb3_waffle_pi_delivery
```
