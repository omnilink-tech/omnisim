...
#    File → Open World → projects/samples/demos/worlds/chat/omnilink_husky.omniworld
#    (or omnilink_jackal.omniworld / omnilink_tb3_burger.omniworld / etc.)
...
# 3. Open https://www.omnilink-agents.com/agents, pick "OmniSim-Roomba", chat.
```
