 ...
 *               in propeller.omniworld spin and eventually fall in spite of control commands aiming at
...
int main() {
  ...
  while (wb_robot_step(time_step) != -1) {
    ...
    wb_supervisor_set_label(3, buffer, LABEL_X, LABEL_Y, 0.07, BLUE, 0, "LiberationSans-Regular");
    sprintf(buffer, "Altitude: %1.1f m", altitude);
    wb_supervisor_set_label(2, buffer, LABEL_X, LABEL_Y + 0.03, 0.07, BLUE, 0, "LiberationSans-Regular");
