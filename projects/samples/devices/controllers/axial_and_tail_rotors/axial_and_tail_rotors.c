 ...
 *               The red helicopter in propeller.omniworld also manages to stabilize
...
int main() {
  ...
  while (wb_robot_step(time_step) != -1) {
    ...
    wb_supervisor_set_label(0, buffer, LABEL_X, LABEL_Y, 0.07, RED, 0, "LiberationSans-Regular");
    sprintf(buffer, "Yaw: %1.1f rad", yaw);
    wb_supervisor_set_label(1, buffer, LABEL_X, LABEL_Y - 0.03, 0.07, RED, 0, "LiberationSans-Regular");
