...
"""
An example of use of a force touch sensor device.
"""
...
class Controller(Robot):
    ...
    def __init__(self):
        ...
        self.force = self.getDevice('force')
        self.force.enable(self.timeStep)
    ...
    def run(self):
        ...
        while self.step(self.timeStep) != -1:
            ...
            force_value = self.force.getValue()
            if force_value > 0.01:
                print(f'Detecting a collision of {force_value} N')
                movement_counter = 15
