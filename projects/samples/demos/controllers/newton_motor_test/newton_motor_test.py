...
projects/samples/demos/worlds/physics/newton_smoke_test.omniworld to verify
OmRotationalMotor -> OmNewtonBackend::setJointTargetVelocity end-to-end.
...
visibly rotate in the per-step log entries from OmNewtonBackend.
