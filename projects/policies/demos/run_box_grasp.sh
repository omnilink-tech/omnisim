...
COURSE="${COURSE:-walkto,4.3,-0.98;stand,6;turn,14,40;stand,2;carryto,5.0,0.2;carryto,7.8,-1.42;carryto,8.55,-1.75;carryto,9.3,-1.55;stand,6;walkto,11.0,-2.6;stand,2;turn,16,40;stand,2;walkto,10.7,1.9;stand,0}"
...
bash projects/policies/training/run_walk_rl.sh "$DUR" "$TAG" deploy "$GUI" \
  ...
  OMNISIM_FOOT_TORSION=0 WALK_WORLD=projects/policies/worlds/g1_box_grasp.wbt \
  ...
  GR_DROP_X=9.10 GR_DROP_Y=-1.75 GR_DROP_R=0.14 GR_DROP_DWELL=45 \
  GR_LOWER_TICKS=150 \
  GR_REL_X=9.15 GR_REL_Y=-1.72 GR_REL_RTOL=0.08 GR_REL_VMAX=0.12 GR_REL_PITCH=-0.65 GR_REL_ELB=1.18 \
