...
# TOP LANDING. Ghost hologram world via SHOW_WORLD=projects/policies/worlds/g1_climb_stairs_demo3_show.wbt.
#
...
bash projects/policies/training/run_walk_rl.sh "$DUR" climb_stairs_stand deploy "$GUI" \
  ...
  WALK_WORLD=${SHOW_WORLD:-projects/policies/worlds/g1_climb_stairs_demo3.wbt} \
