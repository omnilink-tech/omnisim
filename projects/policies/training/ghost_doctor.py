...
Usage:
  python ghost_doctor.py <lut.json> --robot-spec specs/retarget_g1.json \
      [--library "projects/policies/ghosts/g1/ghost_{v3c,v5,v62,v8,unitree,achieved,walkstop_achieved}_lut.json"]
"""
import argparse
import glob
import json
...
def main():
    ...
    ap.add_argument("--library", default="projects/policies/ghosts/g1/ghost_v3c_lut.json,"
                                          "projects/policies/ghosts/g1/ghost_v5_lut.json,"
                                          "projects/policies/ghosts/g1/ghost_v3d_lut.json,"
                                          "projects/policies/ghosts/g1/ghost_official_full_v3_lut.json,"
                                          "projects/policies/ghosts/g1/ghost_unitree_lut.json,"
                                          "projects/policies/ghosts/g1/ghost_achieved_lut.json,"
                                          "projects/policies/ghosts/g1/ghost_walkstop_achieved_lut.json")
    a = ap.parse_args()
