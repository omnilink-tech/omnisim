...
#   * the crawl-collider world (g1_crawl_train.wbt: hands/knees/forearms/torso/
#     pelvis boxes),
...
GHOSTS="$ROOT/projects/policies/controllers/g1_ghost"
...
bash "$ROOT/projects/policies/training/run_walk_rl.sh" "$DUR" "$TAG" "$MODE" "$GUI" \
  ...
  WALK_WORLD=projects/policies/worlds/g1_crawl_train.wbt \
