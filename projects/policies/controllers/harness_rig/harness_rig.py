...
"""harness_rig -- PUPPET rigging + the REAL-box delivery sequence (owner design 2026-07-06).

Draws the harness (semi-transparent yellow line from the puppet's pelvis to a crane hook
...
box = sup.getFromDef("CARRY_BOX")            # the REAL 1.5 kg ODE body (out of the Newton state)
...
while sup.step(ts) != -1:
    ...
    if os.environ.get("PHYS_GRASP", "") == "1":
        ...
        # a REAL Newton body and the deploy's grasp choreography squeezes/lifts it by friction.
