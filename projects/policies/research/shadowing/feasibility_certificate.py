...
in spirit):
  1. CONTACT RECONSTRUCTION.  The committed cert only looks at name-matched
     ...
     belly/knees/elbows, (b) OmniQuad's feet (no foot-named body -> empty set), and
...
OMNIQUAD = _M("projects/policies/research/training/mjcf/omniquad_newton_fixed2.xml")
...
def _self_test():
    ...
    _frozen_apex_jump(GH("omniquad_jump_ghost.npz"), SC("cert_omniquad_frozenjump.npz"))
    _graft_base(GH("omniquad_getup_ghost.npz"), SC("cert_sg_shake.npz"), "shake")
    _graft_base(GH("omniquad_getup_ghost.npz"), SC("cert_sg_drift.npz"), "drift")
    ...
    cases = [
        ...
        ("omniquad crouch",        GH("omniquad_crouch_ghost.npz"), OMNIQUAD, "auto", "pass"),
        ("omniquad getup",         GH("omniquad_getup_ghost.npz"),  OMNIQUAD, "getup", "pass"),
        ("b2 getup",           GH("b2_getup_ghost.npz"),    B2,   "getup", "pass"),
        ("b2 hill6",           GH("b2_hill6_ghost.npz"),    B2,   "hill",  "pass"),
        ("omniquad hill8",         GH("omniquad_hill8_ghost.npz"),  OMNIQUAD, "hill",  "pass"),
        ...
        ("omniquad jump",          GH("omniquad_jump_ghost.npz"),   OMNIQUAD, "jump",  "nopass"),
        # strict negatives (must FAIL, not merely abstain):
        ("go2 levitate",       SC("cert_go2_levi.npz"),     GO2,  "walk",  "fail"),
        ("omniquad frozen-jump",   SC("cert_omniquad_frozenjump.npz"), OMNIQUAD, "jump", "fail"),
        ...
        ("omniquad getup+shake",   SC("cert_sg_shake.npz"),     OMNIQUAD, "getup", "nopass"),
        ("omniquad getup+drift",   SC("cert_sg_drift.npz"),     OMNIQUAD, "getup", "nopass"),
    ]
