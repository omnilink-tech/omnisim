...
Env:
  ...
  HILL_ROBOT       b2 | spot | go2  (selects the URDF motor naming)
...
_SPOT_LEG = {"FL": "front_left", "FR": "front_right", "RL": "rear_left", "RR": "rear_right"}
...
def _motor_candidates(robot, gj):
    ...
    if robot == "spot":
        ...
        return [f"{_SPOT_LEG.get(leg, leg)}_{part}_motor"]
