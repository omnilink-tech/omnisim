...
"""Unitree B2 WALK deploy controller -- the Spot walk-deploy recipe ported.
...
def main() -> int:
    ...
    if policy_path.exists():
        try:
            ...
            say(f"[b2_walk_deploy] ONNX load failed ({e}); ZERO residual\n")
    else:
    ...
    # ── Velocity conditioning + the WALK<->STOP schedule (the Spot port) ──
