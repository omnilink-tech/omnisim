...
"""Sweep Newton engine knob sets for the OmniQuad model-only walker.
...
This sweep finds which knob set restores the OmniQuad walk.

Run: python _scratch/omniquad_newton_knob_sweep.py
"""
...
WORLD = REPO / "projects" / "policies" / "research" / "worlds" / "omniquad_model_walk_demo.omniworld"
