...
"""Open a MuJoCo viewer and watch the GPU-trained Spot policy walk.
...
Run:
    python projects/policies/research/tools/show_spot_walk.py \
        --ckpt projects/policies/research/training/runs/gpu_spot/policy_f26b.pt \
...
def main():
    ...
    ap.add_argument("--ckpt", default=str(REPO / "projects/policies/research/training/runs/gpu_spot/policy_f26b.pt"))
    ap.add_argument("--mjcf", default=r"C:\tmp\spot_newton_export.xml")
