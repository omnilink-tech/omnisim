...
"""HARDEST shadowing test: a OmniQuad FORWARD LEAP with a real FLIGHT phase.
...
Override the GhostGenerator mappings on the instance (anonymous interleaved OmniQuad dump),
same as generate_omniquad_getup.py.

Run: python projects/policies/research/tools/generate_omniquad_jump.py [--vx-launch 1.0 --vz-launch 1.7 ...]
"""
...
def main():
    ...
    ap.add_argument("--out", default=str(_REPO / "_scratch" / "omniquad_jump_ghost.npz"))
    a = ap.parse_args()
    ...
    print("=" * 72)
    print("OMNIQUAD FORWARD-LEAP GHOST -- MPPI (shadowing C1, with a FLIGHT phase)")
    print("=" * 72)
