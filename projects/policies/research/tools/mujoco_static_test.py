...
"""Test if Spot stands stably in our MuJoCo deploy environment when
...
def main():
    ...
    spec_path = Path("projects/policies/research/inference/policies/spot_walk_main/robot_spec.json")
