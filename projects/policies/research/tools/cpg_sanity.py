...
Usage (from repo root):
    SPOT_CPG_FREQ_HZ=1.5 SPOT_CPG_HIP_Y_AMP=0.20 SPOT_CPG_KNEE_AMP=0.30 \
...
def main() -> int:
    os.environ.setdefault("SPOT_CPG_FREQ_HZ", "1.5")
    os.environ.setdefault("SPOT_CPG_HIP_Y_AMP", "0.20")
    os.environ.setdefault("SPOT_CPG_KNEE_AMP", "0.30")
    os.environ.setdefault("SPOT_FIXED_VX", "0.5")
    os.environ.setdefault("SPOT_FIXED_WZ", "0.0")
