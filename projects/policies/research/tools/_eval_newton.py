...
Plays the policy through projects/policies/worlds/spot_newton_demo.wbt headless,
...
Run from repo root:
    python projects/policies/research/tools/_eval_newton.py \\
        --policy projects/policies/research/inference/policies/spot_newton_v2/policy.onnx \\
        --duration 30 --vx 0.3
"""
...
DEPLOY_WORLD = REPO_ROOT / "projects" / "rl" / "worlds" / "spot_newton_demo.wbt"
...
def run_eval(policy_path: Path, duration_s: float, vx: float) -> dict:
    ...
    # in the controller and silently falls back to spot_ppo_main. That
    ...
    # SPOT_TRAIN_WORLD + the env-var unset.
    ...
    # 1.75 Hz-CPG training recipe (train_spot_newton.py), the deploy
    ...
    # before that (CPG off), pass SPOT_CPG_FREQ_HZ=0 in the parent.
