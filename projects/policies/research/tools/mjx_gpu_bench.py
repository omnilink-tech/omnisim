...
"""MJX GPU benchmark with the OmniQuad URDF — measures pure physics
...
# Load OmniQuad URDF through OmniSim's loader (rewrites package:// URIs, adds
# position actuators).
...
print(f"loading OmniQuad URDF: {OMNIQUAD.urdf_path}")
m = load_or_convert(OMNIQUAD.urdf_path,
