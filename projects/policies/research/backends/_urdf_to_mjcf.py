...
The OmniSim OmniQuad URDF is one of these — joint axes, inertials, and the
...
def _rewrite_package_uris(urdf_text: str, urdf_path: Path) -> str:
    ...
    OmniSim URDFs use the ROS convention where `package://omniquad/meshes/foo.stl`
    means the meshes/foo.stl under the omniquad package dir. We assume the
