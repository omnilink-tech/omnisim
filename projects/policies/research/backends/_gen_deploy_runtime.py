...
"""One-shot generator: writes g1_deploy_runtime.py from OmNewtonBackend.cpp.
...
CPP = REPO / "src" / "omnisim" / "physics" / "OmNewtonBackend.cpp"
OUT = REPO / "projects" / "policies" / "research" / "backends" / "g1_deploy_runtime.py"

START = 'kNewtonRuntimeSource = R"PY('
END = '\n)PY";'

DOCSTRING = (
    '"""VERBATIM extract of kNewtonRuntimeSource from OmNewtonBackend.cpp '
