...
Launches the deploy world with OMNIQUAD_DEPLOY_TRACE=1, runs N seconds,
...
def main() -> int:
    ...
    eval_stdout_log = Path(r"C:\tmp\omniquad_eval_stdout.log")
    ...
    if not TRACE_PATH.exists():
        print("[eval] no trace produced; see C:/tmp/omniquad_eval_log.txt")
        return 1
