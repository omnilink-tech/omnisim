...
to ONNX for the spot_rl_deploy controller.
...
spot_rl_deploy.py feeds: sess.run(None, {"obs": obs.reshape(1,-1)})[0][0].
...
Run:
    python projects/policies/research/inference/export_ac_onnx.py \
        --pt projects/policies/research/training/runs/cpu_spot/policy_cpu.pt \
        --out projects/policies/research/inference/policies/gpu_spot/policy.onnx \
