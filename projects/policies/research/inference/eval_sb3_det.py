...
"""Deterministic eval of an SB3 PPO checkpoint against OmniQuadEnv.
...
Run from repo root:
    OMNISIM_NEWTON_TARGET_KD=60 OMNIQUAD_PITCH_TRIM=0.20 OMNIQUAD_FIXED_VX=0.5 ... \
      python projects/policies/research/inference/eval_sb3_det.py \
        --ckpt projects/policies/research/training/runs/omniquad_newton_v31_kd60/checkpoints/omniquad_120000_steps.zip \
        --episodes 5
"""
