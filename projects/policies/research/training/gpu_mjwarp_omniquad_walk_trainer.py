...
"""GPU mujoco_warp trainer for the OmniQuad WALKING policy -- the G1 recipe.

THE OMNIQUAD PORT OF gpu_mjwarp_g1_walk_trainer.py (the canonical sim-to-deploy
template). Architecture: an open-loop FOOT-SPACE TROT reference
(projects/policies/control/gait/omniquad_trot_gait.py -- stance slides at exactly -vx,
...
class BatchedSpotWalkEnv:
    ...
    def _sample_vx_cmd(self, m):
        ...
        walk). OmniQuad's deploy showed the walk gets DILUTED by too much non-
...
def main():
    ...
    p.add_argument("--mjcf", default=r"C:\tmp\omniquad_newton_fixed2.xml")
    p.add_argument("--lr", type=float, default=3e-4)
    p.add_argument("--save",
                   default=str(REPO / "projects/policies/research/training/runs/gpu_omniquad_walk/policy.pt"))
    ...
    p.add_argument("--gait-module", default=None,
                   help="swap the gait reference, e.g. projects.policies.control.gait.omniquad_crawl_gait "
