...
"""Custom trainer for the residual OmniQuad policy.
...
def main() -> int:
    ...
    def make_env(eid):
        return lambda: OmniQuadResidualEnv(env_id=eid, verbose=False)
    ...
    final = run_dir / "omniquad_res_final.zip"
