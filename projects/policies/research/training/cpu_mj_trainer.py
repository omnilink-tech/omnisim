...
"""CPU MuJoCo (mj_step) PPO trainer for the Newton-deploy OmniQuad.
...
projects/policies/research/tools/_eval_omniquad_solver.py: the same CPG+policy moves 0.38 m/s in
...
Run:
    python projects/policies/research/training/cpu_mj_trainer.py --envs 256 --iters 400 \
        --mjcf C:/tmp/omniquad_newton_fixed.xml --save .../policy_cpu.pt
...
def main():
    ...
    p.add_argument("--save", default=str(REPO / "projects/policies/research/training/runs/cpu_omniquad/policy.pt"))
