...
"""Live MuJoCo viewer for the GPU residual OmniQuad walker.
...
Run:
    python projects/policies/research/training/view_gpu_omniquad_residual.py
"""
...
from projects.policies.control.omniquad_gait import GaitParams                       # noqa
from projects.policies.control.omniquad_gait_np import foot_targets_batched          # noqa
from projects.policies.control.omniquad_kinematics_np import inverse_kinematics_batched  # noqa
...
MJCF = r"C:\tmp\omniquad_newton_fixed.xml"
PT = REPO / "projects/policies/research/training/runs/gpu_omniquad_residual_v3/policy_main.pt"
FIXED_VX = 0.5
