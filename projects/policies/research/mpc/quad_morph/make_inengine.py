...
of the OmniQuad deploy URDF + a terrain demo world driven by the deterministic
in-engine locomotion MPC (OMNISIM_INENGINE_MPC_LOCO).

Writes ADDITIVE, clearly-named copies (the originals are NEVER modified):
  - projects/robots/omnisim/omniquad/urdf/omniquad_bigfoot.urdf   (4 foot collision
        spheres -> a flat box sole; lives in the urdf dir so the relative meshes/
        paths still resolve)
  - projects/policies/worlds/omniquad_terrain_mpc_bigfoot.omniworld          (the rough-track
...
URDF = REPO / "projects/robots/omnisim/omniquad/urdf/omniquad.urdf"
URDF_OUT = REPO / "projects/robots/omnisim/omniquad/urdf/omniquad_bigfoot.urdf"
WORLD = REPO / "projects/policies/research/worlds/omniquad_rough_track.omniworld"
# Keep the demo world in research/worlds/ so the `omniquad_walk_deploy` controller
...
WORLD_OUT = REPO / "projects/policies/research/worlds/omniquad_terrain_mpc_bigfoot.omniworld"
...
w = repl(w, '"../../../robots/omnisim/omniquad/urdf/omniquad.urdf"',
         '"../../../robots/omnisim/omniquad/urdf/omniquad_bigfoot.urdf"', 1)
w = repl(w, 'title "OmniQuad walk deploy"',
         'title "OmniQuad BIGFOOT terrain -- deterministic MPC walk (foot-redesign A/B)"', 1)
