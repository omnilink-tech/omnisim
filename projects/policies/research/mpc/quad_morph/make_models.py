...
THE HYPOTHESIS (the quad analog of the G1/H1 foot-redesign finding):
  every quad foot is a single POINT-CONTACT SPHERE (omniquad r=0.035, go2 0.022,
...
ROBOTS = {
    ...
    "omniquad": ("omniquad_newton_fixed2.xml", "omniquad_newton_fixed2_rough.xml", 0.035, -0.32),
...
def gen(robot):
    ...
    s = r / 0.035  # size scale relative to omniquad
    variants = {
...
if __name__ == "__main__":
    import sys
    for rb in (sys.argv[1:] or ["omniquad"]):
        gen(rb)
    print("done.")
