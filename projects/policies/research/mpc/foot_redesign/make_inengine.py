...
Writes two ADDITIVE, clearly-named copies (the originals are never modified):
  ...
  - projects/policies/worlds/g1_hstand_cubethrow_bigfoot.omniworld        (same world, URDFRobot
...
WORLD = REPO / "projects/policies/worlds/g1_hstand_cubethrow.omniworld"
WORLD_OUT = REPO / "projects/policies/worlds/g1_hstand_cubethrow_bigfoot.omniworld"
