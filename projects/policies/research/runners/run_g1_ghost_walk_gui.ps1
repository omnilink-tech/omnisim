...
$world  = "$root\projects\policies\worlds\g1_walk_canon_deploy.wbt"
if (-not $Policy) {
    $Policy = "$root\projects\policies\controllers\g1_ghost_walk\g1_ghost_walk_v6.onnx"  # best deploy transfer (~1.4s upright)
}
