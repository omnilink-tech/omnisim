...
$world = if ($SideThrow) { "$root\projects\policies\research\worlds\g1_standwave_push_throw.omniworld" }
         elseif ($NoRain) { "$root\projects\policies\research\worlds\g1_stand_arms_deploy.omniworld" }
         else            { "$root\projects\policies\research\worlds\g1_standwave_push_rain.omniworld" }
