# Run the DETERMINISTIC BRAIN walk (projects/policies/control/g1_brain.py).
#
# NB this header named control/brain/g1_brain.py until 2026-08-15. That was
# already wrong -- the script sets G1_BRAIN=1 and never sets G1_BRAIN_MODULE,
# so it has always run the consolidated ROOT brain -- and the scratch
# control/brain/ package it pointed at has since been deleted.
#
