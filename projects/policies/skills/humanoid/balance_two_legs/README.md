...
**Class:** humanoid · **Robots:** G1, H1, Valkyrie · **Kind:** deterministic · **Status:** ✅ verified
...
- **arm_balance** — the arms are the *fast* balancer: shoulders swing to shift the CoM and
  ...
  [`arm_motion`](../arm_motion/) skill must keep this live rather than commandeering the arms.
...
roll to ~0; runs robust **cold**. H1 and Valkyrie stand via the same generic harness with
...
that core. Overlays that ride on it: [`arm_motion`](../arm_motion/) (3-D arm exercises),
