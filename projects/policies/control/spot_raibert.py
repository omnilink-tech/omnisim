...
"""Raibert-heuristic trot for Spot — a MODELED gait, not a tuned foot-cycler.
...
layer of the MIT Cheetah controllers):
  ...
  2. STANCE FEET ARE WORLD-ANCHORED. At touchdown the commanded foot
     ...
     backward at v_cmd" assumption (the old spot_gait did exactly that,
...
from .spot_kinematics import HIP_X_POS, forward_kinematics, JointAngles
...
def _selftest() -> None:
    ...
    from .spot_kinematics import inverse_kinematics
    ...
    print("spot_raibert selftest OK (placement, anchoring, reachability)")
