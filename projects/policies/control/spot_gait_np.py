...
Same math as `spot_gait.foot_targets` (stance: linear slide -step/2
...
from .spot_gait import GaitParams, TROT_PHASE_OFFSET
...
def foot_targets_batched(t: np.ndarray, vx: np.ndarray, vy: np.ndarray,
    ...
    # forward. Matches scalar `spot_gait.foot_targets`.
...
def _selftest() -> None:
    from .spot_gait import foot_targets as scalar_foot_targets
