...
"""Analytic forward + inverse kinematics for Spot legs.

Each leg is a 3-link chain: hip_x (X-axis), hip_y (Y-axis), knee (Y-axis).
Dimensions extracted from projects/robots/boston_dynamics/spot/urdf/spot.urdf:
...
def inverse_kinematics(
    ...
    # Spot's knee bends backward (γ < 0) so the foot moves forward and up
...
def _selftest() -> None:
    ...
    import random
    random.seed(0)
    # Nominal stand: matches NOMINAL_POSE in spot_rl_agent.py
    nominal = {
