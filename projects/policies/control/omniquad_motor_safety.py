...
Two pieces:
  ...
  apply_realistic_limits(motors, max_torque_nm, max_vel_rad_s)
    ...
    Webots motor handle. The defaults match the OmniQuad URDF
...
# OmniQuad URDF: <limit effort="80" velocity="20"/> per joint. The 80 Nm
...
OMNIQUAD_MAX_TORQUE_NM = 80.0
OMNIQUAD_MAX_VEL_RAD_S = 8.0
...
def apply_realistic_limits(motors: Sequence,
                           max_torque_nm: float = OMNIQUAD_MAX_TORQUE_NM,
                           max_vel_rad_s: float = OMNIQUAD_MAX_VEL_RAD_S) -> None:
...
OMNIQUAD_RECOVERY_TORQUE_NM = 18.0
OMNIQUAD_RECOVERY_VEL_RAD_S = 3.0


def set_recovery_torque(motors: Sequence,
                        max_torque_nm: float = OMNIQUAD_RECOVERY_TORQUE_NM,
                        max_vel_rad_s: float = OMNIQUAD_RECOVERY_VEL_RAD_S) -> None:
