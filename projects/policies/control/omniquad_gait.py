...
"""Trot foot-trajectory generator for OmniQuad.
...
body frame, ready to feed to `omniquad_kinematics.inverse_kinematics`.
...
from .omniquad_kinematics import HIP_X_POS
