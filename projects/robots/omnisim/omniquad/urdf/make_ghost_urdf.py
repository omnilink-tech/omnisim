...
"""Generate omniquad_ghost.urdf: the OmniQuad URDF with every <inertial> and
...
projects/robots/unitree/g1/urdf/make_ghost_urdf.py).
"""
import xml.etree.ElementTree as ET
from pathlib import Path

HERE = Path(__file__).resolve().parent
SRC = HERE / "omniquad.urdf"
DST = HERE / "omniquad_ghost.urdf"
    ...
    for tag in ("inertial", "collision"):
        for el in link.findall(tag):
            ...
            if tag == "inertial":
                ...
                n_coll += 1
root.set("name", root.get("name", "omniquad") + "_ghost")
