...
REM The released controller bundle includes the public OmniLink SDK and source
REM bridge bootstrap. Prefer it over an unrelated system Python.
if exist "%OMNISIM_HOME%\msys64\mingw64\bin\newton-runtime\python.exe" (
    set "PATH=%OMNISIM_HOME%\msys64\mingw64\bin;%OMNISIM_HOME%\msys64\mingw64\bin\newton-runtime;%PATH%"
)
