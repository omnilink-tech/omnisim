...
"""Apply an equal/opposite spring force at every physics step, never a pose write."""
import argparse
import json
import os
...
def main():
    ...
    try:
        while True:
            ...
            if contact_probe and tick in (100,600,1100):robot.exportImage(str(out/f'probe-{tick}.png'),100)
