...
%figure "Roll, pitch and yaw angles in OmniSim' Inertial Unit"
...
```python
from omnisim import InertialUnit
...
> **Note** [C, C++]: The returned vector is a pointer to internal values managed by the OmniSim, therefore it is illegal to free this pointer.
