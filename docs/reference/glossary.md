...
**Dynamic solid**: A *dynamic solid* is a *solid* which has a [Physics](physics.md) *node* defined and can move according to the OmniSim dynamic physics engine (Newton by default; ODE as the legacy fallback).
