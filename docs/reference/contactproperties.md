...
Changes to `maxContactJoints` may have a significant effect on performance because the computational complexity of the ODE physics engine scales with the cube of the number of contact joints.
