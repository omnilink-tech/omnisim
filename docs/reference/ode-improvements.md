...
In order to extend ODE possibilities and correct some bugs, the version of ODE bundled with OmniSim was improved.
...
By default in ODE, the suspension is along one of the axes of the joint, in the ODE version of OmniSim, the suspension has been improved in order to use any arbitrary axis.
