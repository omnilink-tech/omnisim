...
An example of such a usage is provided in the "supervisor.wbt" sample worlds (located in the "projects/samples/devices/worlds" directory of OmniSim.
...
The "[OMNISIM\_HOME/projects/samples/demos/worlds/misc/cylinder\_stack.wbt]({{ url.github_tree }}/projects/samples/demos/worlds/misc/cylinder_stack.wbt)" project shows how to use this function.
...
The "warehouse_husky.wbt" world, located in the "projects/samples/demos/worlds/showcase" directory, provides a simple example for getting and setting fields with the above described functions.
