...
LinearMotor {
  ...
  SFString sound    "omnisim://projects/default/worlds/sounds/linear_motor.wav"                                                   # any string
}
```

### Description

A [LinearMotor](#linearmotor) node can be used to power a [SliderJoint](sliderjoint.md) and a Track (archived 2026-09-02, see [docs/ARCHIVE.md](../ARCHIVE.md)).
...
When used in velocity control, this maximum force is always applied (with the correct sign) until the target speed is reached.
