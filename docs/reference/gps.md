...
This position can either be expressed in the cartesian coordinate system of OmniSim or using latitude-longitude-altitude, depending on the value of the `gpsCoordinateSystem` field of the [WorldInfo](worldinfo.md) node.
