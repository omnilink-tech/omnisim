...
OmniSim performs dynamic alpha sorting according to the distance between the center of the objects (the local position of the parent [Pose](pose.md)) and the viewpoint.
