...
For example if zAxis is FALSE, then the third element (index 2) of the array returned by the `wb_compass_get_values` function will always return *NaN*.
