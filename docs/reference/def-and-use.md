...
For this reason it is not allowed to insert USE nodes of [Solid](solid.md), [Joint](joint.md), [JointParameters](jointparameters.md), TrackWheel (archived 2026-09-02, see [docs/ARCHIVE.md](../ARCHIVE.md)), and [BallJointParameters](balljointparameters.md) nodes and their derived nodes.
...
Also the [TextureTransform](texturetransform.md) of the first [Shape](shape.md) in the Track (archived 2026-09-02, see [docs/ARCHIVE.md](../ARCHIVE.md)) device with enabled texture animation cannot be a USE node given that the translation values will be automatically updated by OmniSim while the Track device is moving.
