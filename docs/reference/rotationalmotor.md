...
RotationalMotor {
  ...
  SFString sound     "omnisim://projects/default/worlds/sounds/rotational_motor.wav" # any string
}
```
...
When used in velocity control, this maximum torque is always applied (with the correct sign) until the target speed is reached.
