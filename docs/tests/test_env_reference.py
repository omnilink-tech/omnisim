...
NO_DESCRIPTION_TODO = frozenset({
    # 2026-09-09: the Deep Robotics stand/crawl probes (OMNISIM_PROBE_*, OMNISIM_STAND_RAMP_S)
    # and the husky_extreme_terrain film controls (OMNISIM_TERRAIN_*) landed without
    # read-site comments, exactly like the OMNISIM_MAZE_* family before them.
    ...
    "OMNISIM_STAND_RAMP_S",
    "OMNISIM_STRUCTURED_LOG",
    "OMNISIM_TERRAIN_AUTO_QUIT",
    "OMNISIM_TERRAIN_CAMERA_MODE",
    "OMNISIM_TERRAIN_DIRECT_CAMERA",
    "OMNISIM_TERRAIN_FINISH_HOLD_S",
    "OMNISIM_TERRAIN_FRAME_ACCELERATION",
    "OMNISIM_TERRAIN_FRAME_DIR",
    "OMNISIM_TERRAIN_FRAME_START_S",
    "OMNISIM_TERRAIN_MODE",
    "OMNISIM_TERRAIN_RESULT",
    "OMNISIM_TERRAIN_START_DELAY_S",
    "OMNISIM_TERRAIN_TIMEOUT_S",
