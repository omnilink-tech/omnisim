...
OmniSim can simulate a lot of standard robotic sensors.
...
These sensors are listed on the upstream Webots asset catalog under the *sensor* keyword.
...
Alternatively, camera models corresponding to real-world device can be found on the upstream Webots asset catalog.
...
In addition to the generic [Lidar](../reference/lidar.md) node, a wide range of commercial lidar sensors have been modelled and are available from the upstream Webots asset catalog.
...
| ![GPS.png](images/sensors/GPS.png) | [GPS](../reference/gps.md) | *Simulates a positioning sensor which measures the absolute position in OmniSim coordinate system or in the WGS84 coordinate system.* |
