...
For example, when the "husky_fleet_arena.wbt" world is executed, there is a total of eleven processes in memory; one for OmniSim and one for each of the ten Husky controllers.
