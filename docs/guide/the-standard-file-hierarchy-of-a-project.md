...
Some rules have to be followed in order to create a project which can be used by OmniSim.
...
> **Note**: Note that the directories can be created by using the [**File / New / New Project Directory...**](the-user-interface.md) menu item, described in [this chapter](getting-started-with-omnisim.md).
...
These files are written by OmniSim when a world is correctly saved.
...
> **Note**: You can create all the files needed by a new controller using the [**File / New / New Robot Controller...**](the-user-interface.md) menu item, described in [this chapter](getting-started-with-omnisim.md).
