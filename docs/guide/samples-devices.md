...
The "[OMNISIM\_HOME/projects/samples/devices]({{ url.github_tree }}/projects/samples/devices/)" directory contains OmniSim worlds that individually demonstrate the OmniSim devices and their API.

The world files are located in the "[OMNISIM\_HOME/projects/samples/devices/worlds]({{ url.github_tree }}/projects/samples/devices/worlds/)" directory, and their controllers in the "[OMNISIM\_HOME/projects/samples/devices/controllers]({{ url.github_tree }}/projects/samples/devices/controllers/)" directory.
...
### [accelerometer.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/accelerometer.omniworld)
...
### [altimeter.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/altimeter.omniworld)
...
### [battery.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/battery.omniworld)
...
### [brake.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/brake.omniworld)
...
### [bumper.omniworld]({{ url.github_tree }}/projects/samples/devices/worlds/bumper.omniworld)
...
### [camera.omniworld]({{ url.github_tree }}/projects/samples/devices/worlds/camera.omniworld)
...
### [camera\_auto\_focus.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/camera_auto_focus.omniworld)
...
### [camera\_motion\_blur.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/camera_motion_blur.omniworld)
...
### [camera\_noise\_mask.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/camera_noise_mask.omniworld)
...
### [camera\_recognition.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/camera_recognition.omniworld)
...
### [camera\_segmentation.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/camera_segmentation.omniworld)
...
### [compass.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/compass.omniworld)
...
### [connector.omniworld]({{ url.github_tree }}/projects/samples/devices/worlds/connector.omniworld)
...
### [coupled\_motors.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/coupled_motors.omniworld)
...
> **Note**: each finger is an *open chain* — one motorised [HingeJoint](../reference/hingejoint.md) with the fingertip attached rigidly — so the jaws pivot as they close rather than staying parallel.
> The original four-bar parallel-jaw linkage was removed on 2026-08-16: its passive pivot closed a kinematic loop through a [SolidReference](../reference/solidreference.md), which Newton/MuJoCo (a tree-articulation solver) refuses, leaving the whole world with no physics at all.
> The coupled-motor behaviour this sample exists to show is unaffected: one `setPosition` on `motor::left finger` drives both fingers, measured at +0.4200 / -0.4200 rad.

### [display.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/display.omniworld)
...
### [distance\_sensor.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/distance_sensor.omniworld)
...
### [emitter\_receiver.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/emitter_receiver.omniworld)
...
### [encoders.omniworld]({{ url.github_tree }}/projects/samples/devices/worlds/encoders.omniworld)
...
### [force\_sensor.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/force_sensor.omniworld)

**Keywords**: [TouchSensor](../reference/touchsensor.md), force sensor

![force_sensor.png](images/samples/force_sensor.thumbnail.jpg) This example is nearly the same as [bumper.omniworld](#bumperomniworld).
...
### [force3d\_sensor.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/force3d_sensor.omniworld)
...
### [gps.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/gps.omniworld)
...
### [gps\_lat\_long.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/gps_lat_long.omniworld)
...
### [gyro.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/gyro.omniworld)
...
### [imu.omniworld]({{ url.github_tree }}/projects/samples/devices/worlds/imu.omniworld)
...
### [inertial\_unit.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/inertial_unit.omniworld)
...
### [laser\_pointer.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/laser_pointer.omniworld)
...
### [led.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/led.omniworld)
...
### [lidar.omniworld]({{ url.github_tree }}/projects/samples/devices/worlds/lidar.omniworld)
...
### [light\_sensor.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/light_sensor.omniworld)
...
### [linear\_motor.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/linear_motor.omniworld)
...
### [motor.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/motor.omniworld)
...
### [motor2.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/motor2.omniworld)
...
### [motor3.omniworld]({{ url.github_tree }}/projects/samples/devices/worlds/motor3.omniworld)
...
### [pen.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/pen.omniworld)
...
### [position\_sensor.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/position_sensor.omniworld)
...
### [radar.omniworld]({{ url.github_tree }}/projects/samples/devices/worlds/radar.omniworld)
...
### [range\_finder.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/range_finder.omniworld)
...
### [receiver\_noise.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/receiver_noise.omniworld)
...
### [speaker.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/speaker.omniworld)
...
The OmniSim sound should be enabled to hear the result on the computer loudspeakers.

### [speaker\_text\_to\_speech.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/speaker_text_to_speech.omniworld)
...
### [spherical\_camera.wbt]({{ url.github_tree }}/projects/samples/devices/worlds/spherical_camera.omniworld)
...
### [supervisor.omniworld]({{ url.github_tree }}/projects/samples/devices/worlds/supervisor.omniworld)
