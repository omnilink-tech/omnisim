...
### [city.wbt]({{ url.github_tree }}/projects/samples/demos/worlds/environments/city.wbt)
...
### [desert_ruins.wbt]({{ url.github_tree }}/projects/samples/demos/worlds/environments/desert_ruins.wbt)
...
### [forest.wbt]({{ url.github_tree }}/projects/samples/demos/worlds/environments/forest.wbt)

**Keywords**: Forest, woodland, deep mist, cinematic

A deep-mist morning forest, a deciduous–conifer mix with the same level of hand-built detail as the desert scene but tuned for woodland atmosphere. Designed as a backdrop for a husky / spot / etc. composed on top of the tree and floor content.
