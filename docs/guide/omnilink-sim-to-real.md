...
| [`src/omnisim/gui/WbAgentHud.cpp`](../../src/omnisim/gui/WbAgentHud.cpp) | Right-side dock's "Status" + "Chat" tabs (Qt-native equivalent of the above) |
...
| [`projects/samples/demos/controllers/omnilink_quadruped_bridge/omnilink_quadruped_bridge.py`](../../projects/samples/demos/controllers/omnilink_quadruped_bridge/omnilink_quadruped_bridge.py) | Spot bridge — same shape; pose presets, minimal tool surface |
...
| File | What it does |
|---|---|
| [`projects/samples/demos/controllers/_omnilink_relay/omnilink_relay.py`](../../projects/samples/demos/controllers/_omnilink_relay/omnilink_relay.py) | The relay class — wraps `OmniLinkClient.chat()` with single-flight async dispatch + chat-with-tools loop + event surface |
