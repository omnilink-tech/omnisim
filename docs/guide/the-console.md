...
The OmniSim console displays the logs coming from OmniSim (such as parsing warnings or errors when opening a world, compilation outputs, ODE warnings, etc.) and the outputs of the controllers.
