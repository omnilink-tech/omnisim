...
| **Motion coverage** | 1 class (flat-ground foot-contact walk); **missed Spot entirely** (no `foot`-named body) | 6 classes (walk/get-up/jump/hill/sit/arm) + Spot, + INDETERMINATE abstain | self-test table |
...
| **Shadowing in OmniSim** | **Spot / Go2 / B2** | **+30 m / +66 m / +95 m, 0 falls** (Newton SIM deploy, canonical [rl-current-state.md](rl-current-state.md); not hardware) | **certified ghost** |
...
gait** (Spot residual is a "passenger": +4.87 m with policy vs +5.03 m without), and the **G1
...
- **The certificate** went from a broken gate (0/2 discrimination, missed Spot, rubber-stampable)
