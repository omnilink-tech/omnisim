...
projects/policies/
  ...
  worlds/rl_deploy.omniworld      # generic deploy world (Spot URDF as default)
  inference/policies/
...
omnisim-bin projects/policies/research/worlds/rl_deploy.omniworld
```
...
4. Deploy `spot_smoke` in OmniSim (`OMNISIM_POLICY_ONNX=...
   omnisim-bin rl_deploy.omniworld`). Spot should at least not blow up
