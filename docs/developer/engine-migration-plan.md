...
>
> **The rendering arm is finished too (2026-08-23):** wgpu-native is the only renderer and WREN is
> deleted (`976b9449d`). Lines below that say "WREN remains canonical / wgpu is opt-in" are the
> plan as it stood, not the machine.
>
...
> architectural-baseline.md (archived 2026-09-02, see [docs/ARCHIVE.md](../ARCHIVE.md)) — but **NOT** captured
> as a git tag at the time; `architectural-baseline-v1` exists now (`git tag -l`); the only baseline
...
|---|---|---|
| ODE | Single-threaded Gauss-Seidel over coupled joints + contacts | 2-husky head-on: ~98 ms/step. 10-husky: unstable. 20-husky: DNF (archive/fps-optimization-journey.md (archived 2026-09-02, see [docs/ARCHIVE.md](../ARCHIVE.md))) |
...
r3-rendering-backend-evaluation.md (archived 2026-09-02, see [docs/ARCHIVE.md](../ARCHIVE.md)).
...
> 2026-06-07 — documented in architectural-baseline.md (archived 2026-09-02, see [docs/ARCHIVE.md](../ARCHIVE.md)),
> tagged later as `architectural-baseline-v1` — Newton native collision/contacts W1–W4, the wgpu
...
>   design** — the permanent safety net is intact, not removed. *(Historical: ODE was
>   deleted 2026-08-08; a clone without the Newton runtime now has NO physics — `python -m omnisim doctor`.)*
...
architectural-baseline.md (archived 2026-09-02, see [docs/ARCHIVE.md](../ARCHIVE.md)); ⚠️ documented but **NOT**
captured as a git tag at the time — `architectural-baseline-v1` has since been created and is in `git tag -l`;
...
- ✅ **Newton silent-ODE-fallback INIT BUG — FIXED 2026-06-23 (`6a459f84`); the
  ...
  **`OMNISIM_REQUIRE_NEWTON`** (`cfb11d06`, opt-in/default-off) turns an init
  ...
  runtime still falls back to ODE by design *(historical — since 2026-08-08 it has NO physics instead)*. **Verified robot reality on
...
API (physics-contact-impulse-api.md (archived 2026-09-02, see [docs/ARCHIVE.md](../ARCHIVE.md))) is
...
the permanent safety net. *Historical: since 2026-08-08 such a clone has NO physics.*) Paired with this: the **silent-ODE-fallback init bug is fixed** (`6a459f84`)
...
**vs ODE** (per archive/fps-optimization-journey.md (archived 2026-09-02, see [docs/ARCHIVE.md](../ARCHIVE.md))):
...
> archive/fps-optimization-journey.md (archived 2026-09-02, see [docs/ARCHIVE.md](../ARCHIVE.md)) — ODE physics
...
| R3 design | ✅ LANDED + ✅ REFRESHED 2026-05-27 | Backend choice + sub-phase plan recorded in r3-rendering-backend-evaluation.md (archived 2026-09-02, see [docs/ARCHIVE.md](../ARCHIVE.md)). **wgpu-native pick** supersedes April bgfx archive. |
