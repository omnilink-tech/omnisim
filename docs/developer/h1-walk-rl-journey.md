...
- World: [`projects/policies/research/worlds/h1_walk_deploy.omniworld`](../../projects/policies/research/worlds/h1_walk_deploy.omniworld)
...
| Deploy controller / world / harness | `humanoid_walk_deploy.py` / `h1_walk_deploy.omniworld` / `run_humanoid_walk_deploy.ps1` |
