...
| motion classes covered | 1 (flat walk); missed OmniQuad | 6 (walk/get-up/jump/hill/sit/arm) + OmniQuad |
...
| deploy demonstrated | sim only | real H1 (≈42 mm) | real G1 | real Cassie | **SIM only (OmniSim Newton): OmniQuad +30 m / Go2 +66 m / B2 +95 m, 0 falls** |
