...
this work (real-foot world: `projects/policies/worlds/g1_walk_orig.omniworld`):
...
The maintainer-approved reference is **ghost v3c** ([`ghost_v3c_lut.json`](../../projects/policies/ghosts/g1/ghost_v3c_lut.json)):
