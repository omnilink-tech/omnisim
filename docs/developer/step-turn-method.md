...
> This turn is packaged as the **`g1_turn_in_place`** skill ([skill-library.md](skill-library.md) ·
> [`projects/policies/skills/humanoid/g1_turn_in_place/`](../../projects/policies/skills/humanoid/g1_turn_in_place/)).
...
> `walk_turn_walk` / `turn_solo` sequences and `skill_lib.py blendable g1_walk g1_turn_in_place`.
...
- **Output**: the standard ghost lut (`leg_lut`, `wb_lut`, `att_lut`, `root_lut`, `arm_lut`,
  `seq=True`, `hold_end=True`). Preview it: `projects/policies/worlds/g1_step_turn_preview.omniworld`
...
- `projects/policies/ghosts/g1/ghost_step_turn_lut.json` — the ghost.
- `projects/policies/worlds/g1_step_turn_preview.omniworld` — hologram preview.
