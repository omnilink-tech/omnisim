...
- `src/omnisim/util/OmPerformanceLog.*`
...
- `src/omnisim/nodes/utils/OmNodeUtilities.cpp`
...
- `src/omnisim/gui/OmView3D.cpp`
- `src/omnisim/nodes/OmImageTexture.cpp`
- `src/omnisim/nodes/OmBackground.cpp`
- `src/omnisim/nodes/OmCamera.cpp`
- `src/omnisim/wren/*`
- `src/wren/*`
