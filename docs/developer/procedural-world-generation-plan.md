...
- `omniworld validate <world.omniworld>` CLI command exits non-zero if any validator fails.
...
- A single command `omniworld validate <world.omniworld>` is all a user or CI needs.
