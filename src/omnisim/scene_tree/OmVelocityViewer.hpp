...
#ifndef OM_VELOCITY_VIEWER_HPP
#define OM_VELOCITY_VIEWER_HPP
...
class OmVelocityViewer : public QWidget {
  Q_OBJECT

public:
  explicit OmVelocityViewer(QWidget *parent = NULL);
  virtual ~OmVelocityViewer();
