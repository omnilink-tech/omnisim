...
#ifndef OM_ADD_INERTIA_MATRIX_DIALOG_HPP
#define OM_ADD_INERTIA_MATRIX_DIALOG_HPP
...
class OmAddInertiaMatrixDialog : public QDialog {
  Q_OBJECT

public:
  explicit OmAddInertiaMatrixDialog(bool validBoudingObject, QWidget *parent = NULL);
