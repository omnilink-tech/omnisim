...
OmAddInertiaMatrixDialog::OmAddInertiaMatrixDialog(bool validBoudingObject, QWidget *parent) :
  QDialog(parent),
  ...
  connect(cancelButton, &QPushButton::pressed, this, &OmAddInertiaMatrixDialog::reject);
  connect(mAddButton, &QPushButton::pressed, this, &OmAddInertiaMatrixDialog::accept);
  ...
  connect(mTree, &QTreeWidget::itemSelectionChanged, this, &OmAddInertiaMatrixDialog::updateItemInfo);
}

int OmAddInertiaMatrixDialog::inertiaMatrixType() const {
...
void OmAddInertiaMatrixDialog::updateItemInfo() {
...
void OmAddInertiaMatrixDialog::buildTree() {
  // Two top tree items
