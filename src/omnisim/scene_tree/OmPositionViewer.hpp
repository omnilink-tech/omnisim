...
#ifndef OM_POSITION_VIEWER_HPP
#define OM_POSITION_VIEWER_HPP
...
class OmPositionViewer : public QWidget {
  Q_OBJECT

public:
  explicit OmPositionViewer(QWidget *parent = NULL);
  virtual ~OmPositionViewer();

  void show(OmPose *pose);
