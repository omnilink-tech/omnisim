...
#ifndef OM_SOURCE_FILE_EDITOR_HPP
#define OM_SOURCE_FILE_EDITOR_HPP

//
// Description: edits string-valued source-file fields in the scene tree
//
...
class OmExtendedStringEditor : public OmStringEditor {
  Q_OBJECT

public:
  explicit OmExtendedStringEditor(QWidget *parent = NULL);
  virtual ~OmExtendedStringEditor() override;
...
private:
  ...
  static StringType fieldNameToStringType(const QString &fieldName, const OmNode *parentNode);
