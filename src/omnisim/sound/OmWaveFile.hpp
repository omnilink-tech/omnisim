...
#ifndef OM_WAVE_FILE_HPP
#define OM_WAVE_FILE_HPP
...
class OmWaveFile {
public:
  explicit OmWaveFile(const QString &filename, QIODevice *device);
  OmWaveFile(qint16 *buffer, int bufferSize, int channelNumber, int bitsPerSample, int rate);
  virtual ~OmWaveFile();
