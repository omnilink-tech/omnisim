...
OmMicrosoftTextToSpeech::OmMicrosoftTextToSpeech() {
...
qint16 *OmMicrosoftTextToSpeech::generateBufferFromText(const QString &text, int *size, const QString &language) {
...
const QString OmMicrosoftTextToSpeech::error() {
  return gError;
}
