...
OmUpdatedDialog::OmUpdatedDialog(QWidget *parent) : QDialog(parent) {
  setWindowTitle(tr("Welcome to OmniSim %1").arg(OmApplicationInfo::omniSimVersion()));

  QPixmap omniLinkLogo("images:omnisim.png");
  QLabel *image = new QLabel(this);
  image->setGeometry(QRect(16, 15, 50, 50));
  image->setPixmap(omniLinkLogo);
  image->setScaledContents(true);

  QLabel *label = new QLabel(this);
  label->setGeometry(QRect(75, 30, 330, 30));
  label->setText(tr("<b>Thank you for using OmniSim %1.</b>").arg(OmApplicationInfo::omniSimVersion()));
  ...
  label->setText(tr("<p style=\"line-height:1.2\">"
                    ...
                    "href='https://github.com/omnilink-tech/omnisim/blob/main/CHANGELOG.md'>CHANGELOG</a> "
                    "for upgrade notes.</p>"));
  ...
  label->setText(tr("Find out the new features, enhancements and bug fixes of OmniSim %1 in the "
                    "<a style='color: #5DADE2;' "
                    "href='https://github.com/omnilink-tech/omnisim/releases/tag/v%1'>release notes</a>.")
  ...
  connect(closeButton, &QPushButton::pressed, this, &OmUpdatedDialog::close);
}
