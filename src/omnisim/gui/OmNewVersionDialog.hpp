...
#ifndef OM_NEW_VERSION_DIALOG_HPP
#define OM_NEW_VERSION_DIALOG_HPP

//
// Description: This window is opened the first time this minor version of OmniSim is started
//
...
class OmNewVersionDialog : public QDialog {
  Q_OBJECT
