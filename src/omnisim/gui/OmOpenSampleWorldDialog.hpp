...
#ifndef OM_OPEN_SAMPLE_WORLD_DIALOG_HPP
#define OM_OPEN_SAMPLE_WORLD_DIALOG_HPP
...
class OmOpenSampleWorldDialog : public QDialog {
  Q_OBJECT

public:
  explicit OmOpenSampleWorldDialog(QWidget *parent = NULL);
  virtual ~OmOpenSampleWorldDialog();
