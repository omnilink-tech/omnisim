...
#ifndef OM_NEW_WORLD_WIZARD_HPP
#define OM_NEW_WORLD_WIZARD_HPP

//
// Description: Wizard for creating a new OmniSim world
//
...
class OmNewWorldWizard : public QWizard {
  Q_OBJECT

public:
  explicit OmNewWorldWizard(QWidget *parent = NULL);
  virtual ~OmNewWorldWizard();
...
protected:
  ...
  virtual const QString title() const { return tr("Create an OmniSim world file"); }
