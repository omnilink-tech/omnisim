...
QWidget *WbPreferencesDialog::createGeneralTab() {
  ...
  if (WbPreferences::instance()->value("General/theme").toString() != "omnisim_classic.qss") {
  ...
  // row 11
  mCheckWebotsUpdateCheckBox = new QCheckBox(tr("Check for OmniSim updates on startup"), this);
  mCheckWebotsUpdateCheckBox->setToolTip(tr("If this option is enabled, OmniSim will check if a new version is available "
