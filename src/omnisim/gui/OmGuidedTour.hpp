...
#ifndef OM_GUIDED_TOUR_HPP
#define OM_GUIDED_TOUR_HPP

//
// Description: OmniSim Guided Tour dialog
//
...
class OmGuidedTour : public QDialog {
  Q_OBJECT

public:
  // get or create the singleton OmGuidedTour and center on parent
  static OmGuidedTour *instance(QWidget *parent);
...
private:
  ...
  explicit OmGuidedTour(QWidget *parent);
  ~OmGuidedTour();
  void loadWorld();
  void nextWorld();
  void loadWorldList();
