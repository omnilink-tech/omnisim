...
void ConsoleEdit::showCustomContextMenu(const QPoint &pt) {
  ...
  addContextMenuFilterItem(WbLog::filterName(WbLog::ALL_WEBOTS), filterMenu, tr("Display all the messages from OmniSim."));
  ...
  addContextMenuLevelItem(WbLog::filterName(WbLog::ALL_WEBOTS), levelMenu, tr("Display all the OmniSim logs."));
  addContextMenuLevelItem(WbLog::levelName(WbLog::ERROR), levelMenu, tr("Displays OmniSim errors and controller(s) stderr."));
  addContextMenuLevelItem(WbLog::levelName(WbLog::WARNING), levelMenu, tr("Displays OmniSim warnings."));
  addContextMenuLevelItem(WbLog::levelName(WbLog::INFO), levelMenu, tr("Displays OmniSim info."));
  levelMenu->addSeparator();
