...
class OmMouse : public QObject {
  Q_OBJECT

public:
  static OmMouse *create();
  static void destroy(OmMouse *mouse);  // Note: it calls the mouse destructor
  static QList<OmMouse *> &mouses() { return mMouses; }
