...
#ifndef OM_JOYSTICK_INTERFACE__HPP
#define OM_JOYSTICK_INTERFACE__HPP
...
class OmJoystickListener;

class OmJoystickInterface : public QObject {
  Q_OBJECT

public:
  OmJoystickInterface();
  virtual ~OmJoystickInterface();
...
#endif  // OM_JOYSTICK_INTERFACE__HPP
