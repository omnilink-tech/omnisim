...
public:
  ...
  WbSFDouble *bloomThresholdField() const { return mBloomThreshold; }
  WbSFDouble *ambientOcclusionRadiusField() const { return mAmbientOcclusionRadius; }
  WbSFDouble *nearField() const { return mNear; }
