...
OmPolygon::OmPolygon() : mSize(0) {
  mVertices.reserve(32);  // matches the former QVarLengthArray<OmVector2, 32> preallocation
  resize(3);
}
...
bool OmPolygon::contains(double x, double y) const {
...
bool OmPolygon::contains(const OmVector2 &point) const {
