...
#ifndef OM_PROJECT_RELOCATION_DIALOG_HPP
#define OM_PROJECT_RELOCATION_DIALOG_HPP
...
class OmProjectRelocationDialog : public QDialog {
  Q_OBJECT

public:
  // verify that the specified file/directory is located outside of OmniSim installation
...
private:
  ...
  OmLineEdit *mSourceEdit, *mTargetEdit;
  ...
  QMap<OmMFString *, QString> mFieldsToUpdate;
  ...
  explicit OmProjectRelocationDialog(OmProject *project, const QString &relativeFilename, const QString &absoluteFilePath,
                                     QWidget *parent = NULL);
  ~OmProjectRelocationDialog();
