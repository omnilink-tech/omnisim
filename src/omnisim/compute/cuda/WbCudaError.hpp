...
#ifndef WB_CUDA_ERROR_HPP
#define WB_CUDA_ERROR_HPP
...
class WbCudaError : public std::runtime_error {
public:
  WbCudaError(const char *code, const QString &message) :
