...
#ifndef WB_CUDA_SMOKE_HPP
#define WB_CUDA_SMOKE_HPP

//
// Description: in-process M0 smoke for the CUDA compute layer. Exercises
//   WbCudaBuffer's host<->device round trip in the same ABI as omnisim-bin
...
//
//   Wired in via WbApplication::setup() and gated on the
