...
#ifndef OM_PERFORMANCE_LOG_HPP
#define OM_PERFORMANCE_LOG_HPP

//
// Description: class used to debug the performance of OmniSim:
//              - physics step
//              - graphics rendering
//              - controllers
//
...
public:
  ...
  static OmPerformanceLog *instance() { return cInstance; }
...
private:
  static OmPerformanceLog *cInstance;
  OmPerformanceLog(const QString &fileName, int stepsCount);
  OmPerformanceLog(const OmPerformanceLog &);  // non constructor-copyable
  ~OmPerformanceLog();
