...
#ifndef OM_PREFERENCES_HPP
#define OM_PREFERENCES_HPP

//
// Description: non-GUI part of OmniSim preferences
...
class OmPreferences : public QSettings {
  Q_OBJECT

public:
  static OmPreferences *createInstance(const QString &companyName, const QString &applicationName, const OmVersion &version);
...
private:
  OmPreferences(const QString &companyName, const QString &applicationName, const OmVersion &version);
  ~OmPreferences();
