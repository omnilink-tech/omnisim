...
#ifndef OM_PROJECT_HPP
#define OM_PROJECT_HPP
...
class OmProject : public QObject {
  Q_OBJECT

public:
  // singleton: for the current OmniSim project
  static OmProject *current();
  static void setCurrent(OmProject *project);

  // the special "system" project: "WEBOTS_HOME/resources/projects"
  static OmProject *system();

  // the special "default" project: "WEBOTS_HOME/projects/default"
  static OmProject *defaultProject();

  // extra projects defined in the preferences or 'WEBOTS_EXTRA_PROJECT_PATH'
  static QList<OmProject *> *extraProjects();
  ...
  explicit OmProject(const QString &path);
  virtual ~OmProject();
