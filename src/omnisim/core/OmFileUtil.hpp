...
#ifndef OM_FILE_UTIL_HPP
#define OM_FILE_UTIL_HPP

//
// Description: useful file operations for OmniSim
//

#include <QtCore/QString>

namespace OmFileUtil {
  ...
  enum FileType { EXECUTABLE, PYTHON, BOTSTUDIO, DOCKER, UNKNOWN };
