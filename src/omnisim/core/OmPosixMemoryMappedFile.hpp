...
#ifndef OM_POSIX_MEMORY_MAPPED_FILE_HPP
#define OM_POSIX_MEMORY_MAPPED_FILE_HPP

#include <QtCore/QString>

class OmPosixMemoryMappedFile {
public:
  explicit OmPosixMemoryMappedFile(const QString &name);
  ~OmPosixMemoryMappedFile();
