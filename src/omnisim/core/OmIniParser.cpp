...
OmIniParser::OmIniParser(const QString &filename) {
  QFile file(filename);
  QString line;
  QString section;
...
void OmIniParser::setValue(int index, const QString &newValue) {
  mValues[index] = newValue;
}

QString OmIniParser::resolvedValueAt(int index, const QProcessEnvironment &environment) const {
