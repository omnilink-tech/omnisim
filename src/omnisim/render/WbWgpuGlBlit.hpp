...
#ifndef WB_WGPU_GL_BLIT_HPP
#define WB_WGPU_GL_BLIT_HPP

//
// WbWgpuGlBlit — R4 3c-B helper. Uploads an RGBA8 image (top-down, as produced by the wgpu offscreen
...
// dragging glad into a Qt TU (WbView3D), where it would clash with Qt's GL headers. glad's function
...
void WbWgpuGlBlitRgbaToScreen(const unsigned char *rgba, int w, int h);
