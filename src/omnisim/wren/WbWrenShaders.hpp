...
namespace WbWrenShaders {
  ...
  WrShaderProgram *skyTransmittanceShader();
  WrShaderProgram *skyMultiscatteringShader();
  WrShaderProgram *skyViewShader();
  WrShaderProgram *skyApplyShader();
  WrShaderProgram *skyToCubemapShader();
