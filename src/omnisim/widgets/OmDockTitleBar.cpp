...
OmDockTitleBar::OmDockTitleBar(bool hasFloatButton, QWidget *parent) : QFrame(parent) {
  if (hasFloatButton)
  ...
  if (hasFloatButton) {
    ...
    connect(mFloatButton, &QPushButton::clicked, this, &OmDockTitleBar::floatClicked);
  } else
    mFloatButton = NULL;
  ...
  connect(mCloseButton, &QPushButton::clicked, this, &OmDockTitleBar::closeClicked);
  connect(mToggleButton, &QPushButton::clicked, this, &OmDockTitleBar::toggle);
}

OmDockTitleBar::~OmDockTitleBar() {
}

void OmDockTitleBar::setTitle(const QString &title) {
  mTitle = title;
  updateTitle();
}

void OmDockTitleBar::setMaximized(bool maximized) {
...
void OmDockTitleBar::setFloating(bool floating) {
  mToggleButton->setVisible(!floating);
  updateTitle();
}

void OmDockTitleBar::resizeEvent(QResizeEvent *event) {
  updateTitle();
}

int OmDockTitleBar::computeNumberOfButtons() {
  int buttons = 0;
...
void OmDockTitleBar::updateTitle() {
