...
#ifndef OM_DOCK_TITLE_BAR_HPP
#define OM_DOCK_TITLE_BAR_HPP

//
// Description: title bar for OmDockWidget and OmSimulationView
...
class OmDockTitleBar : public QFrame {
  Q_OBJECT

public:
  explicit OmDockTitleBar(bool hasFloatButton, QWidget *parent = NULL);
  virtual ~OmDockTitleBar();
