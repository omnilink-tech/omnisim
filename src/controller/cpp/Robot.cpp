...
#include <omnisim/plugins/robot_window/robot_window.h>
#include <omnisim/plugins/robot_window/robot_wwi.h>
#include <omnisim/robot.h>
#include <omnisim/Device.hpp>
#include <omnisim/Robot.hpp>

#include <omnisim/Accelerometer.hpp>
#include <omnisim/Altimeter.hpp>
#include <omnisim/Brake.hpp>
#include <omnisim/Camera.hpp>
#include <omnisim/Compass.hpp>
#include <omnisim/Connector.hpp>
#include <omnisim/Device.hpp>
#include <omnisim/Display.hpp>
#include <omnisim/DistanceSensor.hpp>
#include <omnisim/Emitter.hpp>
#include <omnisim/GPS.hpp>
#include <omnisim/Gyro.hpp>
#include <omnisim/InertialUnit.hpp>
#include <omnisim/Joystick.hpp>
#include <omnisim/Keyboard.hpp>
#include <omnisim/LED.hpp>
#include <omnisim/Lidar.hpp>
#include <omnisim/LightSensor.hpp>
#include <omnisim/Motor.hpp>
#include <omnisim/Mouse.hpp>
#include <omnisim/Pen.hpp>
#include <omnisim/PositionSensor.hpp>
#include <omnisim/Radar.hpp>
#include <omnisim/RangeFinder.hpp>
#include <omnisim/Receiver.hpp>
#include <omnisim/Skin.hpp>
#include <omnisim/Speaker.hpp>
#include <omnisim/TouchSensor.hpp>
#include <omnisim/VacuumGripper.hpp>
