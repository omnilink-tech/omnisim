...
static bool get_webots_home() {
  ...
  WEBOTS_HOME = malloc(strlen(home) + 1);
  strcpy(WEBOTS_HOME, home);
  return true;
}
...
int main(int argc, char **argv) {
  ...
  // Python controller
    ...
    fprintf(stderr,
            "The file extension '%s' is not supported as webots controller. Supported file types are executable files and '.py'.\n",
