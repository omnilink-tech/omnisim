...
#include <omnisim/radio.h>
#include "device_private.h"
#include "messages.h"
#include "robot_private.h"
#include "scheduler.h"

// NOTE: `struct WebotsRadioEvent` keeps its name deliberately. It is PUBLIC ABI, declared in
// include/plugins/radio.h and passed by pointer across the radio-plugin boundary (the engine side
// is OmRadio.cpp), so an already-compiled third-party radio plugin depends on the spelling.
// Renaming it is an ABI break and is out of scope for the internal naming migration.
