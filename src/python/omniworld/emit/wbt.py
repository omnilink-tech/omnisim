...
_VRML_HEADER = "#VRML_SIM R2025a utf8\n"
...
def _emit_prop(prop: PlacedProto, instance_index: int) -> list[str]:
    ...
    # Webots warns on sibling Solids that share a ``name``. The recipe
...
def render_wbt(world: WorldDescription) -> str:
    ...
    # Post-process effect controls. Webots defaults bloomThreshold=21
