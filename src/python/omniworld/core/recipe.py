...
class PlacedProto:
    ...
    - ``proto_type`` is the PROTO type name as written in Webots
...
class PlacedSolid:
    ...
    ``face_indices`` is the Webots ``coordIndex`` flat list, with ``-1``
...
class WorldDescription:
    ...
    # World time step (ms). Matches the Webots WorldInfo.basicTimeStep field.
    ...
    # unset; ``fog_visibility_range`` is the Webots field of the same
    ...
    fog_type: str = "EXPONENTIAL"  # Webots: "LINEAR", "EXPONENTIAL", "EXPONENTIAL2"
