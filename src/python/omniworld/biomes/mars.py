...
DEFAULT_PARAMS: dict[str, Any] = {
    ...
    # OmniSim physics pulls them down onto the ground on the first
    ...
    # Controller name OmniSim looks for in
    ...
    # ``distribution/generated_worlds/``; must be a path OmniSim can
...
# by OmniSim at load time, so it must be correct for the output's
