...
class Driver(Supervisor):
    ...
    def loadApi() -> ctypes.cdll:
        ...
        ctypes.cdll.LoadLibrary(os.path.join(omnisim_home, path, car))
        Driver.api = ctypes.cdll.LoadLibrary(os.path.join(omnisim_home, path, driver))
    ...
    # private function for external ROS bridges to identify robots that can use libdriver
    @staticmethod
