...
export default class MouseEvents {
  ...
  #onMouseDown(event) {
    ...
    if (typeof omnisim.currentView.onmousedown === 'function')
      omnisim.currentView.onmousedown(event);
  ...
  #onMouseMove(event) {
    ...
    if (!this.#enableNavigation && event.button === 0) {
      if (typeof omnisim.currentView.onmousemove === 'function')
        omnisim.currentView.onmousemove(event);
      return;
    }
    ...
    if (typeof omnisim.currentView.onmousemove === 'function')
      omnisim.currentView.onmousemove(event);
    if (typeof omnisim.currentView.onmousedrag === 'function')
      omnisim.currentView.onmousedrag(event);
  }
  ...
  #onMouseUp(event) {
    ...
    if (typeof omnisim.currentView.onmouseup === 'function')
      omnisim.currentView.onmouseup(event);
  }
  ...
  onMouseLeave(event) {
    ...
    if (typeof omnisim.currentView.onmouseleave === 'function')
      omnisim.currentView.onmouseleave(event);
  ...
  #onTouchMove(event) {
    ...
    if (typeof omnisim.currentView.ontouchmove === 'function')
      omnisim.currentView.ontouchmove(event);
  }
  ...
  #onTouchStart(event) {
    ...
    if (typeof omnisim.currentView.ontouchstart === 'function')
      omnisim.currentView.ontouchstart(event);
  ...
  #onTouchEnd(event) {
    ...
    if (typeof omnisim.currentView.ontouchend === 'function')
      omnisim.currentView.ontouchend(event);
  }
