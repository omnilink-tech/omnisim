...
export default class InformationPanel {
  constructor(parentNode) {
    ...
    this.webotsPresentation.innerHTML = `
      <h2>OmniSim<span class=cloud> ` + version + `</span></h2>
      <p>Open-source robot simulator, by <a href="https://www.omnilink-agents.com" target="_blank">OmniLink</a> &mdash; for OmniLink agents.</p>
      <p>Built on <a href="https://github.com/cyberbotics/webots" target="_blank">Webots</a> by Cyberbotics Ltd.</p>
      <a href="https://github.com/omnilink-tech/omnisim" target="_blank">github.com/omnilink-tech/omnisim</a>`;
