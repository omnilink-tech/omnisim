...
export default class ProtoManager {
  ...
  getXmlOfMinimalScene() {
    ...
    imageTexture.setAttribute('url', 'https://raw.githubusercontent.com/omnilink-tech/omnisim/main/projects/default/worlds/textures/grid.png');
  ...
  #createGeometryWrapper() {
    ...
    const imageTexture = xml.createElement('ImageTexture');
    imageTexture.setAttribute('url', 'https://raw.githubusercontent.com/omnilink-tech/omnisim/main/projects/default/worlds/textures/tagged_wall.jpg');
    imageTexture.setAttribute('role', 'baseColorMap');
    appearance.appendChild(imageTexture);
