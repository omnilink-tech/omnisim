...
if 'OMNISIM_HOME' in os.environ:
    OMNISIM_HOME = os.environ['OMNISIM_HOME']
else:
    raise RuntimeError('Error, OMNISIM_HOME variable is not set.')

SKIPPED_FILES = []

OUTPUT_FILE = os.path.join(OMNISIM_HOME, 'resources', 'web', 'wwi', 'protoVisualizer', 'FieldModel.js')


def list_files():
    files = []
    for root_path, _, file_names in os.walk(os.environ['OMNISIM_HOME']):
...
if __name__ == '__main__':
    ...
    for file in files:
        ...
        with open(file, 'r') as f:
            ...
            data[node_name]['icon'] = 'https://raw.githubusercontent.com/omnilink-tech/omnisim/main/resources/nodes'\
