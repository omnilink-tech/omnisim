export default class Progress {
  ...
  constructor(parentNode, message, image) {
    ...
    this.#progressPanelTitle.innerHTML = '<p>OmniSim</p>';
    ...
    this.#progressPanelSubtitle.innerHTML = 'Open-source robot simulator, by OmniLink.';
    ...
    this.#progressPanelVersion.innerHTML = 'OmniSim — built on Webots R2025a';
    ...
    this.#progressPanelCopyright.innerHTML = '&copy; OmniLink &middot; Upstream Webots &copy; Cyberbotics 1998-2025';
  ...
  #setDefaultImage() {
    this.#progressImage.src = '/resources/web/wwi/images/loading/default_thumbnail.png';
  }
}
