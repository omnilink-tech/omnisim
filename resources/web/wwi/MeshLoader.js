export default class MeshLoader {
  static loadMeshData(prefix, url) {
    ...
    if (url.startsWith('omnisim://')) {
      ...
      if (typeof MeshLoader.owner === 'undefined')
        MeshLoader.owner = 'omnilink-tech';
      if (typeof MeshLoader.repository === 'undefined')
        MeshLoader.repository = 'omnisim';
      if (typeof MeshLoader.branch === 'undefined' || MeshLoader.branch === '')
        MeshLoader.branch = 'main';
      url = url.replace('omnisim://', 'https://raw.githubusercontent.com/' + MeshLoader.owner + '/' +
                                      MeshLoader.repository + '/' + MeshLoader.branch + '/');
    }
