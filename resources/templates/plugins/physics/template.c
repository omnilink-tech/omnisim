...
void webots_physics_init() {
   ...
   * Your code should correcly handle the NULL cases because otherwise a segmentation fault will crash OmniSim.
   *
...
int webots_physics_collide(dGeomID g1, dGeomID g2) {
  /*
   * This function needs to be implemented if you want to overide OmniSim collision detection.
...
void webots_physics_cleanup() {
   ...
   * You do not need to free any ODE object, they will be freed by OmniSim.
   */
