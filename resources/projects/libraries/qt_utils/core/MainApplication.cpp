...
MainApplication::MainApplication() {
  ...
  app->setWindowIcon(QIcon("icons:omnisim.png"));
}
...
MainApplicationPrivate::MainApplicationPrivate(int &argc, char **argv) : QApplication(argc, argv), mIsInitialized(false) {
  // OMNISIM_PIPE_IN is the only name libController sets; the WEBOTS_PIPE_IN alias was retired.
  mPipeInHandler = QString(qgetenv("OMNISIM_PIPE_IN")).toInt();
