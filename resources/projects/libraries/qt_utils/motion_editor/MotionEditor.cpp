...
void MotionEditor::openMotion() {
  ...
  QString filePath =
    QFileDialog::getOpenFileName(this, tr("Open motion file"), lastDirectory, tr("OmniSim Motion Files (*.motion)"), NULL);
...
void MotionEditor::saveAsMotion() {
  QString filePath =
    QFileDialog::getSaveFileName(this, tr("Save motion file"), mMotion->filePath(), tr("OmniSim Motion Files (*.motion)"), NULL);
